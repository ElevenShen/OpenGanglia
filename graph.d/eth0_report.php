...
function graph_eth0_report ( &$rrdtool_graph ) {
    ...
    if ($context != 'host') {
       ...
       $rrdtool_graph['title'] = "$hostname eth0 last $range";
    }
    ...
    $series = "DEF:'bytes_in'='${rrd_dir}/eth0_in_rate.rrd':'sum':AVERAGE "
       ."DEF:'bytes_out'='${rrd_dir}/eth0_out_rate.rrd':'sum':AVERAGE "
