...
if (!$_GET['screenX'] and !preg_match('/graph.php/',$_SERVER["SCRIPT_NAME"])) {
...
#get image cache time
$img_cache_dir = "cache/meta/";
$img_cache_timeout = 30;
?>
