...
$tpl = new TemplatePower( template("ex_host_view.tpl") );
...
$cluster_url = $ex_alllist[$hostname]['CLUSTERNAME'];
...
<tr><td align=left width=50>Mem:</td><td width=90> $mem[total] </td><td width=90>$mem[used]</td><td width=90>$mem[free]</td><td width=90>$mem[shared]</td><td width=90>$mem[buffers]</td><td width=90>$mem[cached]</td><tr>\n
...
<tr><td align=left>Swap:</td><td>$swap[total]</td><td>$swap[used]</td><td>$swap[free]</td></tr>\n
	...
	$uptime = date('H:i:s').' up '.$s_metrics['uptime']['VAL'];
...
$tpl->newBlock("frame");
$tpl->assign("frame_url", "?c=$cluster_url&h=$hostname&frame=y&screenX=$screenX");
